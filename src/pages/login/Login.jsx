            ...
            <div className="admin-2fa-right">
              ...
              <div className="admin-download-item">
                ...
                <div className="admin-download-link">
                  ...
                  <span>/</span>
                  <a target="_blank" href="https://apps.apple.com/tw/app/google-authenticator/id388497605">
                    IOS版
                  </a>
                </div>
              </div>
              <div className="admin-download-item">
                ...
                <div className="admin-download-link">
                  ...
                  <span>/</span>
                  <a target="_blank" href="https://apps.apple.com/tw/app/microsoft-authenticator/id983156458">
                    IOS版
                  </a>
                </div>
              </div>
              <div className="admin-download-item">
                ...
                <div className="admin-download-link">
                  ...
                  <a target="_blank" href="https://play.google.com/store/apps/details?id=com.verisign.mvip.main&hl=en">
                    安卓版
                  </a>
                  <span>/</span>
                  <a target="_blank" href="https://apps.apple.com/hk/app/vip-access-for-iphone/id307658513">
                    IOS版
                  </a>
                </div>
              </div>
...
// App 包裹：https://ant-design.antgroup.com/components/app-cn
// 提供可消费 React context 的 message.xxx、Modal.xxx、notification.xxx 的静态方法，可以简化 useMessage 等方法需要手动植入 contextHolder 的问题
// 解决类似报错：[antd: message] Static function can not consume context like dynamic theme. Please use 'App' component instead.
const Login = () => (
  <App>
    <LoginPage />
  </App>
