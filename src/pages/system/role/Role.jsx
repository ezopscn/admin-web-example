...
const PageHeaderTips = () => {
  return (
    <ul>
      ...
      <li>可以把角色当成用户组来理解，所以系统不再提供用户组管理功能。同时，系统预留了两个默认角色，该角色无法修改，删除：
        <ul>
          <li><b>ADMINISTRATOR（超级管理员）</b>：系统最高权限的角色，后续即使创建了和它相同权限的角色，依然无法替代它。
          </li>
          <li><b>GUEST（访客）</b>：系统最低权限角色，当用户没有任何角色的时候，默认分配该角色。</li>
        </ul>
      </li>
    </ul>
  );
